...
from predict import enter_stock,prep_data, prep_model, peek, plot_raw_hist, test_models, predict_cart, predict_knn, predict_cart_and_knn
...
predict_cart(X,Y,X_train,Y_train,X_validation,Y_validation,60)
